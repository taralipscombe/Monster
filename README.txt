...
In a new Terminal window, change your directory to the location of where the zip has been downloaded to, using the "cd" command.
Open the zip folder by typing "unzip eba82_tli88_Project.zip" 
